      ...
      <IonContent>
        <div className="grid">
          <IonCard className="grid--card">
            <IonCardHeader>
              <IonCardTitle>
                Número de conversaciones ({stats.countConversations})
              </IonCardTitle>
            </IonCardHeader>
            <div className="card--chart">
              <RenderAreaChart
                data={stats.countConversationsByTime}
              ></RenderAreaChart>
            </div>
          </IonCard>
          <IonCard className="grid--card">
            <IonCardHeader>
              <IonCardTitle>
                Número de conversaciones por calificación
              </IonCardTitle>
            </IonCardHeader>
            <div className="card--chart">
              <RenderPieChart
                data={stats.groupByRateConversations}
              ></RenderPieChart>
            </div>
          </IonCard>
          <IonCard className="grid--card">
            <IonCardHeader>
              <IonCardTitle>
                Número de conversaciones por calificación en el tiempo
              </IonCardTitle>
            </IonCardHeader>
            <div className="card--chart">
              <RenderStackedBarChart
                data={stats.groupByRateConversationsByTime}
              ></RenderStackedBarChart>
            </div>
          </IonCard>
        </div>
